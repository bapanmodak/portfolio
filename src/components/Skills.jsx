...
const Skills = () => {
  return (
    <motion.div
      className="w-full overflow-x-hidden lg:px-12 xl:px-48 py-20"
    ...
    >
      ...
      >
        {skillsData.map((skill) => (
          <div
            key={skill.id}
            className="mx-4 md:mx-8 flex flex-col items-center justify-center p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out border border-secondary h-[120px] md:h-[150px] lg:h-[200px] w-[100px] md:w-[150px] lg:w-[200px]"
          >
            <div className="flex flex-col items-center justify-center">
              ...
              />
              <p className="text-sm lg:text-lg text-center font-semibold text-white align-text-bottom ">
                {skill.name}
              </p>
            </div>
          </div>
