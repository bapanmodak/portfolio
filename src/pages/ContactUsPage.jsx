  ...
  return (
    <div>
      <div className="">
        ...
        >
          <h1 className="text-5xl font-bold text-center mt-28 lg:mt-0">
            Contact Me
          </h1>
        ...
        <div className="bg-[#2a2c39] py-6">
          <h1 className="text-2xl md:text-3xl lg:text-5xl text-center lg:pt-12 ">
